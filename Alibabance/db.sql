...
CREATE TABLE if not exists Inventaire (id_produit integer PRIMARY KEY,id_modele integer, nom char(60),stock integer,taille double, cout_produit double, FOREIGN KEY (id_modele) REFERENCES Produits(id_modele));
